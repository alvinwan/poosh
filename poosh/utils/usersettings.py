...
Written by @glvnst https://github.com/glvnst/usersettings/blob/master/usersettings.py
Python3 upgrade by @zachdeibert https://github.com/glvnst/usersettings/pull/2/files
"""
...
class Settings(dict):
    ...
    def remove_setting(self, setting_name):
        """ Remove a settings option """
        return self.pop(setting_name)
    ...
    def save_settings(self):
        ...
        parser = ConfigParser.RawConfigParser()
        parser.remove_section('settings')
